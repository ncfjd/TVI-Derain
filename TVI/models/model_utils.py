...
def get_arch(opt,model):
    ...
    if arch in ARCH_list:
        ...
        model_restoration = RLP_NightRain(model=model ,in_c=3, out_c=3, use_rlp=use_rlp, use_rpim=use_rpim, rlp_feat=32, dm_type=dm_type, opt=opt)
    else:
